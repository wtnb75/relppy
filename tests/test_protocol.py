...
class TestProtocol(unittest.TestCase):
    def test_pack0(self):
        self.assertEqual(Message(123, b"hello").pack(), b"123 hello 0\n")

    def test_pack(self):
        self.assertEqual(
            Message(1234, b"hello", b"world").pack(), b"1234 hello 5 world\n"
        )

    def test_str(self):
        self.assertEqual(
            "txnr=1234 command='hello' data='world'",
    ...
    def test_unpack0(self):
        ...
        self.assertEqual(msg, Message(123, b"hello"))
    ...
    def test_unpack(self):
        ...
        self.assertEqual(len(d), msg.unpack(d))
        self.assertEqual(msg, Message(1234, b"hello", b"world"))

    def test_unpack_nl(self):
        msg = Message()
        d = b"1234 hello 11 wor d\nworld\n"
        self.assertEqual(len(d), msg.unpack(d))
        self.assertEqual(msg, Message(1234, b"hello", b"wor d\nworld"))
